document.addEventListener("DOMContentLoaded", function () {
	...
	const runes = [
		{
			group: 1,
			atts: [
				{ rus: "Феху", eng: "Fehu", de: "Fehu", img: "/img/runes/fehu.png" },
				{ rus: "Хагалаз", eng: "Hagalaz", de: "Hagalaz", img: "/img/runes/hagalaz.png" },
				{ rus: "Тейваз", eng: "Teiwaz", de: "Tiwaz", img: "/img/runes/teiwaz.png" }
			]
		},
		{
			group: 2,
			atts: [
				{ rus: "Уруз", eng: "Uruz", de: "Uruz", img: "/img/runes/uruz.png" },
				{ rus: "Наутиз", eng: "Nauthiz", de: "Nauthiz", img: "/img/runes/nauthiz.png" },
				{ rus: "Беркана", eng: "Berkana", de: "Berkana", img: "/img/runes/berkana.png" }
			]
		},
		{
			group: 3,
			atts: [
				{ rus: "Турисаз", eng: "Thurisaz", de: "Thurisaz", img: "/img/runes/thurisaz.png" },
				{ rus: "Иса", eng: "Isa", de: "Isa", img: "/img/runes/isa.png" },
				{ rus: "Эваз", eng: "Ehwaz", de: "Ehwaz", img: "/img/runes/ehwaz.png" }
			]
		},
		{
			group: 4,
			atts: [
				{ rus: "Ансуз", eng: "Ansuz", de: "Ansuz", img: "/img/runes/ansuz.png" },
				{ rus: "Йера", eng: "Jera", de: "Jera", img: "/img/runes/jera.png" },
				{ rus: "Манназ", eng: "Mannaz", de: "Mannaz", img: "/img/runes/mannaz.png" }
			]
		},
		{
			group: 5,
			atts: [
				{ rus: "Райдо", eng: "Raido", de: "Raido", img: "/img/runes/raido.png" },
				{ rus: "Эйваз", eng: "Eihwaz", de: "Eiwaz", img: "/img/runes/eihwaz.png" },
				{ rus: "Лагуз", eng: "Laguz", de: "Laguz", img: "/img/runes/laguz.png" }
			]
		},
		{
			group: 6,
			atts: [
				{ rus: "Кеназ", eng: "Kenaz", de: "Kenaz", img: "/img/runes/kenaz.png" },
				{ rus: "Перт", eng: "Perth", de: "Perth", img: "/img/runes/perth.png" },
				{ rus: "Ингуз", eng: "Inguz", de: "Inguz", img: "/img/runes/inguz.png" }
			]
		},
		{
			group: 7,
			atts: [
				{ rus: "Гебо", eng: "Gebo", de: "Gebo", img: "/img/runes/gebo.png" },
				{ rus: "Альгиз", eng: "Algiz", de: "Algiz", img: "/img/runes/algiz.png" },
				{ rus: "Отала", eng: "Othala", de: "Othala", img: "/img/runes/othala.png" }
			]
		},
		{
			group: 8,
			atts: [
				{ rus: "Вуньо", eng: "Wunjo", de: "Wunjo", img: "/img/runes/wunjo.png" },
				{ rus: "Совило", eng: "Sowulo", de: "Sowilo", img: "/img/runes/sowulo.png" },
				{ rus: "Дагаз", eng: "Dagaz", de: "Dagaz", img: "/img/runes/dagaz.png" }
			]
		},
		{
			group: 9,
			atts: [
				{ rus: "Неопределенная позиция", eng: "", de: "", img: "/img/runes/empty.png" },
				{ rus: "Неопределенная позиция", eng: "", de: "", img: "/img/runes/empty.png" },
				{ rus: "Неопределенная позиция", eng: "", de: "", img: "/img/runes/empty.png" }
			]
		}
	...
	rcForm.addEventListener("submit", (event) => {
		...
		if (language === "ru") {
			...
			if (!isLatin(name) || !isLatin(surname)) {
				alert("Bitte geben Sie Ihren Vor- und Nachnamen in lateinischen Zeichen ein.");
				return false;
			}
		}
	...
	<img src="${ORIGIN_URL + essenceRune.rune.img}" alt="${essenceRune.rune.rus}">
	<div>
		<h5>
			<em>${essenceRune.rune.rus} ${essenceRune.rune.eng ? '(' + essenceRune.rune.eng + ')' : ''}</em>
		</h5>
		<small>Руническая группа: ${essenceRune.group}<br style="display: block;">Атт: ${essenceRune.att}</small>
	</div>`;
		document.querySelector(
			"#personalityRune"
		).innerHTML = `
	<img src="${ORIGIN_URL + personalityRune.rune.img}" alt="${personalityRune.rune.rus}">
	<div>
		<h5>
			<em>${personalityRune.rune.rus} ${personalityRune.rune.eng ? '(' + personalityRune.rune.eng + ')' : ''}</em>
		</h5>
		<small>Руническая группа: ${personalityRune.group}<br style="display: block;">Атт: ${personalityRune.att}</small>
	</div>`;
		document.querySelector(
			"#goldenRune"
		).innerHTML = `
	<img src="${ORIGIN_URL + goldenRune.rune.img}" alt="${goldenRune.rune.rus}">
	<div>
		<h5>
			<em>${goldenRune.rune.rus} ${goldenRune.rune.eng ? '(' + goldenRune.rune.eng + ')' : ''}</em>
		</h5>
		<small>Руническая группа: ${goldenRune.group}<br style="display: block;">Атт: ${goldenRune.att}</small>
	</div>`;
