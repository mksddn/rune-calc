document.addEventListener("DOMContentLoaded", function () {
	...
	document.querySelector(
		"#essenceRune"
	).innerHTML = `<img src="${essenceRune.rune.img}" alt="${essenceRune.rune.rus}"><h5><em>${essenceRune.rune.rus} (${essenceRune.rune.eng})</em></h5><small>Руническая группа: ${essenceRune.group}<br>Атт: ${essenceRune.att}</small>`;
	document.querySelector(
		"#personalityRune"
	).innerHTML = `<img src="${personalityRune.rune.img}" alt="${personalityRune.rune.rus}"><h5><em>${personalityRune.rune.rus} (${personalityRune.rune.eng})</em></h5><small>Руническая группа: ${personalityRune.group}<br>Атт: ${personalityRune.att}</small>`;
	document.querySelector(
		"#goldenRune"
	).innerHTML = `<img src="${goldenRune.rune.img}" alt="${goldenRune.rune.rus}"><h5><em>${goldenRune.rune.rus} (${goldenRune.rune.eng})</em></h5><small>Руническая группа: ${goldenRune.group}<br>Атт: ${goldenRune.att}</small>`;
